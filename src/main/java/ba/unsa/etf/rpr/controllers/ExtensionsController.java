...
/**
 *ExtensionsController class is responsible for scheduling an appointment for hair extensions.
...
public class ExtensionsController{
    ...
    public ExtensionsController(){
        services.add("Micro-bead Extensions");
        services.add("Tape-in Extensions");
        services.add("Clip-in Extensions");
        services.add("Weft Hair Extensions");
    }
    /**
    ...
    public void confirmButtonOnAction(ActionEvent actionEvent) throws HairsalonException {
        if(serviceId.getValue()==null || stylistPickId.getValue()==null  || datePickerId.getValue()==null){
            ...
            if (service.contains("Micro")) {
                appointments.setPrice("200$");
                appointments.setDuration(130);
            } else if (service.contains("Tape")) {
                appointments.setPrice("155$");
                appointments.setDuration(145);
            } else if (service.contains("Clip")) {
                appointments.setPrice("145$");
                appointments.setDuration(160);
            } else if (service.contains("Weft")) {
